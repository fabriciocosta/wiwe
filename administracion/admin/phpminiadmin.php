...
if ( $_SESSION['idusuario'] > 0 ) {
	...
	include '../include/bloqueofooter.php';
	return;
}
...
*/
 ...
 $DB=array(
 'user'=>$_USUARIO_,#required
 'pwd'=>$_CONTRASENA_, #required
 'db'=>$_DB_,  #default DB, optional
 'host'=>$_SERVIDOR_,#optional
 'port'=>"",#optional
