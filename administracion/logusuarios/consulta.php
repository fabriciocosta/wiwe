...
<form name="consultar" method="post" action="consulta.php">
			<!--FILTROS-->
				<table border="0" cellpadding="0" cellspacing="10">
					...
					<tr>
						<td  colspan="3"><? $tabla->FiltrarCampo('NICK_USUARIO'); ?></td>
					...
					<tr>
						<td colspan="3"><? $tabla->FiltrarCampo('IP'); ?></td>
					</tr>
					<tr>
						<td colspan="3"><? $tabla->FiltrarCampo('ID_USUARIO'); ?></td>
					</tr>
					<tr>
						<td colspan="3"><? $tabla->FiltrarCampo('LOGS'); ?></td>
					</tr>
				</table>
			<!--FIN FILTROS-->
...
<? 
	if ($_consulta_=='si') {
		$tabla->LimpiarSQL();
		$tabla->FiltrarSQL('NICK_USUARIO');
		$tabla->FiltrarSQL('IP');
		$tabla->FiltrarSQL('ID_USUARIO');
		$tabla->FiltrarSQL('LOGS');		
