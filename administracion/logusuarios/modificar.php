...
<? include "../include/camposheader.php";?>
			...
			<form name="confirmar" method="post" action="confirmar.php">				
				<table border="0" cellpadding="0" cellspacing="10">
					<tr>
						<td colspan="1"><?$tabla->EditarCampo('NICK_USUARIO');?></td>
						<td rowspan="4" valign="bottom"><? include "../include/okcancel.php";?></td>
					</tr>
					<tr>
						<td colspan="1"><?$tabla->EditarCampo('IP');?></td>
					</tr>
					<tr>
						<td colspan="1"><?$tabla->EditarCampo('ID_USUARIO');?></td>
					</tr>
					<tr>
						<td colspan="1"><?$tabla->EditarCampo('LOGS');?></td>
					</tr>										
				</table>
			<!--FIN CAMPOS-->
...
<? 
	$tabla->FiltrarSQL('NICK_USUARIO','','escondido');
	$tabla->FiltrarSQL('IP','','escondido');
	$tabla->FiltrarSQL('ID_USUARIO','','escondido');
	$tabla->FiltrarSQL('LOGS','','escondido');	
