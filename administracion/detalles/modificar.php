...
<? include "../include/camposheader.php";?>
			...
			<form name="confirmar" method="post" action="confirmar.php">				
				<table border="0" cellpadding="0" cellspacing="10">
					...
					<tr>						
						<td><?$tabla->EditarCampo('ID_TIPODETALLE');?></td>
					</tr>
					<tr>
						<td><?$tabla->EditarCampo('DETALLE');?></td>
					</tr>
					<tr>
						<td><?$tabla->EditarCampo('ML_DETALLE');?></td>
					</tr>											
					<tr>
						<td><?$tabla->EditarCampo('TXTDATA');?></td>
					</tr>
					<tr>
						<td><?$tabla->EditarCampo('ML_TXTDATA');?></td>
					</tr>				
				</table>
			<!--FIN CAMPOS-->
...
<script>changetoIframeEditor(document.forms[0]._e_CUERPO);</script>