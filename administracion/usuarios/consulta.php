...
<form name="consultar" method="post" action="consulta.php">
			<!--FILTROS-->
				<table border="0" cellpadding="0" cellspacing="10">
					...
					<tr>
						<td  colspan="2"><? $tabla->FiltrarCampo('NICK'); ?></td>
					...
					<tr>
						<td colspan="1"><? $tabla->FiltrarCampo('NOMBRE'); ?></td>
					</tr>
					<tr>
						<td colspan="1"><? $tabla->FiltrarCampo('APELLIDO'); ?></td>												
					</tr>
					<tr>											
						<td colspan="2"><? $tabla->FiltrarCampo('MAIL'); ?></td>						
					</tr>					
				</table>
			<!--FIN FILTROS-->
...
<? 
	if ($_consulta_=='si') {
		$tabla->LimpiarSQL();
		$tabla->FiltrarSQL('NICK');
		$tabla->FiltrarSQL('NOMBRE');
		$tabla->FiltrarSQL('APELLIDO');
		$tabla->FiltrarSQL('MAIL');
