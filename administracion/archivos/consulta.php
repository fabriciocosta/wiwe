			...
			<!--FILTROS-->
				<table border="0" cellpadding="0" cellspacing="10">
					...
					<tr>
						...
						<td><? $tabla->FiltrarCampo('ID_TIPOARCHIVO'); ?></td>						
					...
					<tr>
						<td colspan="2"><? $tabla->FiltrarCampo('NOMBRE'); ?></td>
					</tr>
					<tr>
						<td colspan="2"><? $tabla->FiltrarCampo('URL'); ?></td>
					</tr>					
					<tr>											
